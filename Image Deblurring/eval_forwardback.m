function eval_forwardback(obj, inputs, addnoise, derOutputs, varargin)
...
obj.computingDerivative = nargin > 3 && ~isempty(derOutputs) ;
...
obj.holdOn = 1;    %opts.holdOn ;
out1 = obj.getVarIndex('prediction') ;
derOutputs{1,2} = obj.vars(out1).value - addnoise;
