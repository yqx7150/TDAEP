function [net,stats] = DnCNN_train_2sigmaP25W20(net, varargin)
...
opts.gpus = [];
opts.numEpochs = 300 ;
opts.modelName   = 'model_2sigmaP25W20';
...
label1 = zeros(size(input1),'single');
label1(:,:,1,:) = Pnoiselevel/255*randn(size(input1(:,:,1,:)),'single');
label1(:,:,2:5,:) = Wnoiselevel/255*randn(size(input1(:,:,2:5,:)),'single');
